  ...
  return (
    <Link href={`/shoes/${shoe.slug}`} className="group overflow-hidden bg-white transition hover:bg-[#fbfaf7]">
      <div className="relative aspect-[4/3] border-b border-black/10 bg-[#f7f7f5] p-5">
        ...
        <img src={image.url} alt={`${shoe.brand} ${shoe.model}, ${image.label.toLowerCase()} view`} className="h-full w-full object-contain mix-blend-multiply transition duration-500 group-hover:scale-[1.03]" />
      </div>
      <div className="p-5">
